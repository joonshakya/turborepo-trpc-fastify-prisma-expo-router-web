# turborepo-trpc-fastify-prisma-expo-router-web
...
```bash
npx create-turbo@latest -e https://github.com/joonshakya/turborepo-trpc-fastify-prisma-expo-router-web
```

## About

This is my template to create a fullstack typescript mobile application using Expo, Expo Router, React Native Web, tRPC, Fastify and Prisma.
...
apps
  ...
  ├─ expo
  |   ├─ Expo SDK 51
  |   ├─ React Native 0.74.1 using React 18
